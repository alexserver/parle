  ...
  return (
    <div className='space-y-8'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        <Link
          to='/upload'
          className='group relative bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white p-4 rounded-xl shadow-lg transition-all duration-200 transform hover:scale-105'
        >
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p className='text-blue-100'>Upload MP3, MP4, or M4A files for transcription</p>
            </div>
          </div>
        </Link>
        ...
        <Link
          to='/transcripts'
          className='group relative bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white p-4 rounded-xl shadow-lg transition-all duration-200 transform hover:scale-105'
        >
          <div className='flex items-center space-x-4'>
            <div className='flex-shrink-0'>
              <svg className='h-8 w-8' fill='none' viewBox='0 0 24 24' stroke='currentColor'>
              ...
              >
                <div className='flex items-center justify-between'>
                  <div className='flex-1'>
                    ...
                    <p className='text-sm text-gray-500 mt-1'>{formatDate(transcript.createdAt)}</p>
                  </div>
                  <div className='ml-4'>
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded-full ${getStatusColor(transcript.status)}`}
                    >
                      {transcript.status}
                    </span>
                  </div>
